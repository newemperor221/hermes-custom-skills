...
|--------|-----|--------|--------|---------|
| LA (<运维本机_IP>) | <运维本机_IP> | 43827 | UFW | sshd jail 启用 |
| LA-1c2.5g (<旧Master_IP>) | <旧Master_IP> | 28394 | iptables | sshd jail 启用 |
| 纽约 (<纽约_IP>) | <纽约_IP> | 22 | 重装后待配 | 待装 |
| 亚特兰大 (<亚特兰大_IP>) | <亚特兰大_IP> | 15927 | 重装后待配 | 待装 |
| KS (<KS_IP>) | <KS_IP> | 65239 | 待配 | 待装 |
| TK (<东京_IP>) | <东京_IP> | 45781 | 待配 | 待装 |
