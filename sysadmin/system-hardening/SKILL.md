...
# 手动清除某个 IP 的限制
echo "165.154.155.174" > /proc/net/xt_recent/SSH-LIMIT
...
command_args="-e http://31.58.51.127:45774 -t <NODE_TOKEN> --disable-web-ssh"
...
- **攻击者 IP**：`165.154.155.174`（UCloud HK），84 次登录，持续 20 小时
...
⚠️ **关键安全原则**：永远不要从被黑机子扫攻击者。攻击者可能在你机子上留了反制/log 脚本。用第三方堡垒机/本机扫。本 session 是从 CCS LA2（198.46.147.71）经由 sshpass 上主控扫的。
...
|--------|-----|------|---------|--------|
| 主控 荷兰 | 31.58.51.127 | 46748 | ✅ | ✅ iptables + recent限速 |
| 56idc 洛杉矶 | 107.172.231.70 | 42185 | ✅ | ✅ iptables（需`apk add iptables iptables-openrc`安装） |
| GCP 台湾 | 35.189.164.32 | 43590 | ✅ | - |
| isvoro 首尔 | 146.56.191.86 | 10260 | ✅ | - |
| isvoro 新加坡 | 140.245.97.144 | 10425 | ✅ | - |
